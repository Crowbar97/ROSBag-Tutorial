...
def main():
    ...
    argparser.add_argument(
        '--config',
        help='path to camera configuration .yml file, see example above',
        required=True
    )
    argparser.add_argument(
        '--left_image_topic',
        help='left camera image topic name (type: sensor_msgs/Image)',
        default = '/stereo/left/image_raw'
    )
    argparser.add_argument(
        '--right_image_topic',
        help='right camera image topic name (type: sensor_msgs/Image)',
    ...
    argparser.add_argument(
        '--atlans_topic',
        help='atlans odom topic name (type: nav_msgs/Odometry)',
        # default = '/atlans_odom'
    )
    argparser.add_argument(
        '--encoding',
        help='new encoding (mono8, mono16, bgr8, rgb8, bgra8, rgba8)',
        default = 'bgr8'
    )
    argparser.add_argument(
        '--outdir', '-o',
